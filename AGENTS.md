...
- Changing an S3 backend in inventory changes configuration only; it does not migrate existing Gitea objects. Follow `docs/gitea.md`'s object-storage migration procedure before switching providers.
